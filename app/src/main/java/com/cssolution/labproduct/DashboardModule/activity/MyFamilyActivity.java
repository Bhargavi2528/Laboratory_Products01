...
import com.cssolution.labproduct.databinding.ActivityMyFamilyBinding;

public class MyFamilyActivity extends AppCompatActivity {

    ActivityMyFamilyBinding binding;
    MyFamilyActivity context = MyFamilyActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(context, R.layout.activity_my_family);
        ...
        if (savedInstanceState == null) {
            ...
            binding.toolbar.tvToolbar.setText(R.string.myfamily);
...
//                binding.toolbar.ivNotification.setVisibility(View.INVISIBLE);
        ...
        binding.lAddmember.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
