...
import com.cssolution.labproduct.databinding.ActivityContactusBinding;

public class ContactusActivity extends AppCompatActivity {

    ActivityContactusBinding binding;
    ContactusActivity context = ContactusActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(context, R.layout.activity_contactus);

        if (savedInstanceState == null) {

            binding.toolbar.ivBackarrow.setVisibility(View.VISIBLE);
            binding.toolbar.ivNotification.setVisibility(View.INVISIBLE);
            binding.toolbar.tvToolbar.setText(R.string.contactus);
