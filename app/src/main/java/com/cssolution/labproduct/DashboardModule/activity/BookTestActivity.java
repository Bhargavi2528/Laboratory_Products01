...
import com.cssolution.labproduct.databinding.ActivityBookTestBinding;

public class BookTestActivity extends AppCompatActivity {

    ActivityBookTestBinding binding;
    BookTestActivity context = BookTestActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(context, R.layout.activity_book_test);

        if (savedInstanceState == null) {

            binding.toolbar.ivBackarrow.setVisibility(View.VISIBLE);
            binding.toolbar.ivNotification.setVisibility(View.INVISIBLE);
            binding.toolbar.tvToolbar.setText(R.string.searchtests);
